...
def handle_whatsapp_message(body):
    ...
    # response = message_body # make_openai_request(message_body, message["from"])

    if not message_body:  # type: ignore
        return
    if message_body == "START":
        ...
        response = "Thank you for letting us know you moved! Please provide your new address so we can update our records."
    elif message_body == "2":
        response = "Thanks for the update on your insurance! Please share the details of your new insurance provider and policy number."
    elif message_body == "3":
        response = "We understand that cost can be a concern. Please let us know if you'd like to discuss payment options or financial assistance."
    elif message_body == "4":
        ...
        response = "No worries! Let's get you scheduled. Please provide your preferred dates and times for an appointment."
    else:
